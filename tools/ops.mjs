...
export const OP = {
  ...
  OP_RESERVED:0x50, OP_1:0x51, OP_2:0x52, OP_3:0x53, OP_4:0x54, OP_5:0x55, OP_6:0x56,
...
export function push(b) {
  ...
  if (b.length < 0x100) return [OP.OP_PUSHDATA1, b.length, ...b]
  if (b.length < 0x10000) return [OP.OP_PUSHDATA2, b.length & 0xff, b.length >> 8, ...b]
