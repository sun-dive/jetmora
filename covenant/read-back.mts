...
const lock: any = buildAnchorLock({
  levels: LEVELS, creator,
  state: { genesis: Array(32).fill(0x9a), branch: Array(32).fill(0), depth: 0, treesize: 0, royalty: 1, forkable: 1, leafcovers: 1, owner: Array(20).fill(0x77), ...payees },
})
