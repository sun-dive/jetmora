...
for (const N of [1, 3, 5]) {
  const lock = buildAnchorLock({
    levels: N, creator: Array(20).fill(0xc1),
    state: { genesis: Array(32).fill(9), branch: Array(32).fill(0), depth: 0, treesize: 0, royalty: 1, forkable: 1, leafcovers: 1, ownera: Array(20).fill(7), ...payees(N) },
  })
